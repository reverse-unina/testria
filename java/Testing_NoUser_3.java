...
* @author Giuseppe
*/
public class Testing_NoUser_3 extends SeleniumTestCase {
    ...
    public boolean test() {
        ...
        for(int i = 0; i < cmd.length; i++){
            ...
            StancaValidator.getIdInterface(cluster, selenium.getLocation(), Testing_NoUser_3.class,Integer.parseInt(cmd[i][2]), ai, assertInterface);
            StancaValidator.requisito1(selenium, Testing_NoUser_3.class, ai);
            StancaValidator.requisito2(selenium, Testing_NoUser_3.class, ai);
            StancaValidator.resultCount(Testing_NoUser_3.class, ai);
            if(assertInterface){
                ...
                StancaValidator.printTestTimeInterface(Testing_NoUser_3.class,startDateInterface,endDateInterface,Integer.parseInt(cmd[i][2]),ai);
                break;
            }
            endDateInterface=System.currentTimeMillis();
            StancaValidator.printTestTimeInterface(Testing_NoUser_3.class,startDateInterface,endDateInterface,Integer.parseInt(cmd[i][2]),ai);
        ...
        resultTime.add(tt);
        StancaValidator.printTestTime(Testing_NoUser_3.class, startDateTest, endDateTest, tt);
    ...
    public void createLogToFile(List analizyedInterfaces) {
        try {
            ...
            Writer outputWriter = new FileWriter("C:/TestRia/stancaReport/Testing_NoUser_3.xml");
            ...
            Logger.getLogger(Testing_NoUser_3.class.getName()).log(Level.SEVERE," Errore creazione file di log ", ex);
    ...
    public static void main(String[] args) {
        Testing_NoUser_3 myTest = new Testing_NoUser_3();
